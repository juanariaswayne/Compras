...
{
    public partial class Frm_ProdOCDirecta : Form
    {
        ...
        #region varibles publicas
            ...
            public IAddItemOCDirecta Opener { get; set; }
        #endregion

        #region Funciones
            public Frm_ProdOCDirecta()
            {
                InitializeComponent();
            }
            ...
            private void Frm_ProdOCDirecta_Load(object sender, EventArgs e)
        {
            //this.bindingSourceOCDirecta.DataSource = _articulosItem;
            CargarRubros();
        }
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            this.bindingSourceOCDirecta.DataSource = q;
        }


        private void dataGridViewProdOCDirecta_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            this.Opener.AddNewItemOCDirecta(this.dataGridViewProdOCDirecta.Rows[e.RowIndex].Cells[0].Value.ToString(), this.dataGridViewProdOCDirecta.Rows[e.RowIndex].Cells[1].Value.ToString(), this.dataGridViewProdOCDirecta.Rows[e.RowIndex].Cells[2].Value.ToString());
            this.Close();
            this.Dispose();
        }
        ...
        private void dataGridViewProdOCDirecta_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (this.dataGridViewProdOCDirecta.CurrentCell.ColumnIndex > 0 && this.dataGridViewProdOCDirecta.CurrentCell.ColumnIndex < 3)
                {
                    this.Opener.AddNewItemOCDirecta(this.dataGridViewProdOCDirecta.Rows[this.dataGridViewProdOCDirecta.CurrentCell.RowIndex].Cells[0].Value.ToString(), this.dataGridViewProdOCDirecta.Rows[this.dataGridViewProdOCDirecta.CurrentCell.RowIndex].Cells[1].Value.ToString(), this.dataGridViewProdOCDirecta.Rows[this.dataGridViewProdOCDirecta.CurrentCell.RowIndex].Cells[2].Value.ToString());
                    this.Close();
                    this.Dispose();

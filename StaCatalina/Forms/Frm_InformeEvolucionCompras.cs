...
{
    public partial class Frm_InformeEvolucionCompras : Plantilla
    {
        ...
        #region Function
            ...
            public Frm_InformeEvolucionCompras()
            {
                InitializeComponent();
            }
        ...
        #region Eventos
            ...
            private void FrmInformeEvolucionCompras_Load(object sender, EventArgs e)
            {
            ...
            private void toolStripButtonPrint_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    String reportPath = ConfigurationManager.AppSettings["Reports"] + "\\Reporting\\" + "HistoricoImputacionCompras.rpt";

...
{
    public partial class Frm_ProdIngresoStock : Form
    {
        ...
        #region varibles publicas
            ...
            public IAddItemIngStock Opener { get; set; }
        #endregion
        
        public Frm_ProdIngresoStock()
        {
            InitializeComponent();
        }
        ...
        private void Frm_ProdIngresoStock_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Opener.AddNewItemIngStock(this.dataGridViewProdIngStock.Rows[e.RowIndex].Cells[0].Value.ToString(), this.dataGridViewProdIngStock.Rows[e.RowIndex].Cells[1].Value.ToString(), this.dataGridViewProdIngStock.Rows[e.RowIndex].Cells[2].Value.ToString(), Convert.ToBoolean(this.dataGridViewProdIngStock.Rows[e.RowIndex].Cells[4].Value));
            this.Close();
            this.Dispose();
        }
        ...
        private void dataGridViewProdIngStock_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (this.dataGridViewProdIngStock.CurrentCell.ColumnIndex > 0 && this.dataGridViewProdIngStock.CurrentCell.ColumnIndex < 3)
                {
                    this.Opener.AddNewItemIngStock(this.dataGridViewProdIngStock.Rows[this.dataGridViewProdIngStock.CurrentCell.RowIndex].Cells[0].Value.ToString(), this.dataGridViewProdIngStock.Rows[this.dataGridViewProdIngStock.CurrentCell.RowIndex].Cells[1].Value.ToString(), this.dataGridViewProdIngStock.Rows[this.dataGridViewProdIngStock.CurrentCell.RowIndex].Cells[2].Value.ToString(), Convert.ToBoolean(this.dataGridViewProdIngStock.Rows[this.dataGridViewProdIngStock.CurrentCell.RowIndex].Cells[4].Value));
                    this.Close();
                    this.Dispose();
